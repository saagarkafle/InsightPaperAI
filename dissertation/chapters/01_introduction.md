...
\newline \newline It is within this technological context that InsightPaper AI is conceived: a full-stack, end-to-end RAG system designed specifically for grounded research paper analysis, combining fine-tuned semantic retrieval, multi-model LLM generation, and an interactive evaluation framework.
...
\newline \newline These challenges collectively motivate the development of InsightPaper AI: a system that integrates fine-tuned dense retrieval, multi-model LLM generation with source grounding, and a comprehensive automated evaluation framework within a single, accessible web application. 

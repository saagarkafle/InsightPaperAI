...
The Ask Questions tab contains the core interactive RAG question-answering interface. It allows users to ask natural language questions about the indexed paper and receive precise, grounded answers generated by the active LLM.

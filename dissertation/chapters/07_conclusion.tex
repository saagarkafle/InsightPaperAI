...
The project implemented and applied a three-metric evaluation framework combining Token-Level F1, Semantic Vector Similarity, and LLM-as-a-Judge ratings \citep{zheng2023judging}. This framework demonstrated that each metric captures qualitatively distinct aspects of answer quality, and that no single metric is sufficient for comprehensive RAG evaluation. The framework is generalisable to other RAG systems beyond InsightPaper AI.
